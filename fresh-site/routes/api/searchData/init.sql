...
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('Deer', 'deer.jpeg', 'polymer clay', 1, 25.00, 1);
...
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('Panda Stack Charm', 'panda_stack.jpeg', 'polymer clay', 1, 25.00, 1);
...
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('Ramen Charm', 'ramen.jpeg', 'polymer clay', 1, 25.00, 1);
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('Seaturtle', 'seaturtle.jpeg', 'polymer clay', 1, 25.00, 1);
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('Snowy Owl', 'snowy_owl.jpeg', 'painting', 1, 25.00, 1);
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('Tiger', 'tiger.jpeg', 'polymer clay', 1, 25.00, 1);
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('Turtle Stack Charm', 'turtle_stack.jpeg', 'polymer clay', 1, 25.00, 1);
...
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('The Lost Princess', 'cat_princess.png', 'epoxy clay', 1, 3500, 3);
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('Gold Dragon', 'gold_dragon.png', 'epoxy clay', 1, 1200, 3);
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('By The Shore', 'by_the_shore.png', 'epoxy clay', 1, 4000, 3);
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('A New Beginning', 'a_new_beginning.png', 'epoxy clay', 1, 1800, 3);
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('Adore', 'adore.png', 'epoxy clay', 1, 1600, 3);
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('Before I Wake Up', 'before_i_wake_up.png', 'epoxy clay', 1, 3200, 3);
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('Dancing Flames By The Sea', 'dancing_flames_by_the_sea.png', 'epoxy clay', 1, 4500, 3);
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('Family', 'family.png', 'epoxy clay', 1, 3200, 3);
INSERT INTO ARTWORK(title, image, medium, stock, price, artist_id) VALUES ('The Lost Princess', 'healing.png', 'epoxy clay', 1, 1700, 3);
